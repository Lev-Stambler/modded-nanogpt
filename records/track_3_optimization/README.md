...
| 16 | 3125(!) | 3.2784 (n=8) | Setup from #14, plus SOAP precond for attention with trust gate (note: no evidence that this is doing anything beyond getting more stat sig) | 2026/05/05 | [log](results/20260506_trustlight/fake_log_from_seed0.txt) | [PR](https://github.com/KellerJordan/modded-nanogpt/pull/283) | @SPThole |
