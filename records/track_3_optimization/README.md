...
| 16 | 3125(!) | 3.2784 (n=8)✓ | Setup from #14, plus SOAP precond for attention with trust gate (note: this record is [Tier 2](#tier-1-vs-tier-2-results)) | 2026/05/05 | [log](results/20260506_trustlight/fake_log_from_seed0.txt) | [PR](https://github.com/KellerJordan/modded-nanogpt/pull/283) | @SPThole |
...
We could say that there are two tiers of world-record results: Both tiers of achieve statistical significance at a lower step count than the previous record they are comparing against.
