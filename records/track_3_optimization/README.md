...
| 13 | 3150 | 3.2783 (n=6)✓ | [KL-SOAP](https://arxiv.org/abs/2509.03378) with hyperball constraint on hidden matrices, precondition_frequency=1, lr=.018, beta1=.95, beta2=.9, shampoo_beta=.95, aux Adam, and per-module init std (attn.proj std=.026, mlp.proj std=.031, mlp.fc std=.031, qkv default) | 2026/05/08 | [log](results/20260508_klsoap_h_b2_09_3150/klsoap-h-b2-09-pf1-K3150-run-1.txt) | [PR](https://github.com/KellerJordan/modded-nanogpt/pull/290) | @kaiyue-wen |
